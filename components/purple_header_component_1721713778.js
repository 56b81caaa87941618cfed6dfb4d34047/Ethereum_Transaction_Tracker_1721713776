...
Vue.component("purple_header_component_1721713778", {
    template: `
            ...
            <div class="flex items-center justify-between h-16 md:h-20">
                ...
                <nav id="desktop-navigation" class="hidden md:flex md:grow">
                    ...
                    <ul id="desktop-menu-links" class="flex grow justify-center flex-wrap items-center">
                        ...
                        <li><a id="Search Transactions-link" class="font-medium text-sm mx-4 lg:mx-5 transition duration-150 ease-in-out" href="Search Transactions.html" :class="[textStylePrimary, hoverTextStylePrimary]">Search Transactions</a></li>
                        <li><a id="Track Wallets-link" class="font-medium text-sm mx-4 lg:mx-5 transition duration-150 ease-in-out" href="Track Wallets.html" :class="[textStylePrimary, hoverTextStylePrimary]">Track Wallets</a></li>
                        <li><a id="Analytics Tools-link" class="font-medium text-sm mx-4 lg:mx-5 transition duration-150 ease-in-out" href="Analytics Tools.html" :class="[textStylePrimary, hoverTextStylePrimary]">Analytics Tools</a></li>
                        <li><a id="Developer APIs-link" class="font-medium text-sm mx-4 lg:mx-5 transition duration-150 ease-in-out" href="Developer APIs.html" :class="[textStylePrimary, hoverTextStylePrimary]">Developer APIs</a></li>
                    </ul>
                ...
                <div id="mobile-menu" class="md:hidden flex items-center ml-4" x-data="{ expanded: false }">
                    ...
                    <nav id="mobile-nav" class="absolute top-full z-20 left-0 w-full px-4 sm:px-6 overflow-hidden transition-all duration-300 ease-in-out" x-ref="mobileNav" :style="expanded ? 'max-height: ' + $refs.mobileNav.scrollHeight + 'px; opacity: 1' : 'max-height: 0; opacity: .8'" @click.outside="expanded = false" @keydown.escape.window="expanded = false" x-cloak>
                        <ul id="mobile-nav-list" class="border border-transparent rounded-lg px-4 py-1.5" :class="signUpButtonGradient">
                            ...
                            <li><a id="mobile-Search Transactions-link" class="flex font-medium text-sm py-1.5" href="Search Transactions.html" :class="[textStylePrimary,hoverTextStylePrimary]">Search Transactions</a></li>
                            <li><a id="mobile-Track Wallets-link" class="flex font-medium text-sm py-1.5" href="Track Wallets.html" :class="[textStylePrimary,hoverTextStylePrimary]">Track Wallets</a></li>
                            <li><a id="mobile-Analytics Tools-link" class="flex font-medium text-sm py-1.5" href="Analytics Tools.html" :class="[textStylePrimary,hoverTextStylePrimary]">Analytics Tools</a></li>
                            <li><a id="mobile-Developer APIs-link" class="flex font-medium text-sm py-1.5" href="Developer APIs.html" :class="[textStylePrimary,hoverTextStylePrimary]">Developer APIs</a></li>
                        </ul>
                    </nav>
